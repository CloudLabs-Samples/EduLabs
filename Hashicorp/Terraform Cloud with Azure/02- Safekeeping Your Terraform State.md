...
5. Next, edit the **terraform.tfvars** file, replacing the **rgname** with your name
...
6. In the same file, replace the **location** with your location, ensure to save the file
