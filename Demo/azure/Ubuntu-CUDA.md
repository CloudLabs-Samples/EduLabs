# CloudLabs Demo: CUDA Parallel Programming

The environment has CUDA and Eclipse preinstalled in an Ubuntu Virtual machine with NVIDIA GPU.
...
6. You can use the Virtual machine and tools as needed.
