...
1. Run the report job again.
    ...
    **Expected Output:**
    ...
    ![](https://docs-api.cloudlabs.ai/repos/raw.githubusercontent.com/CloudLabs-Samples/EduLabs/refs/heads/main/Demo/Azure-VM-Troubleshooting-Lab/LabGuidePackage/Image/m02-portal-vm-identity.png)
...
1. Run the following command to inspect the storage account's network configuration.
    ...
    **Expected Output:**
    ...
    ![](https://docs-api.cloudlabs.ai/repos/raw.githubusercontent.com/CloudLabs-Samples/EduLabs/refs/heads/main/Demo/Azure-VM-Troubleshooting-Lab/LabGuidePackage/Image/m02-portal-storage-firewall-before.png)
...
1. Run the following command to confirm the firewall now allows one virtual network rule and still denies everything else.
    ...
    **Expected Output:**
    ...
    ![](https://docs-api.cloudlabs.ai/repos/raw.githubusercontent.com/CloudLabs-Samples/EduLabs/refs/heads/main/Demo/Azure-VM-Troubleshooting-Lab/LabGuidePackage/Image/m02-portal-storage-firewall-after.png)
...
1. The new identity has **no role assignments at all**. Even if it had **Owner** or **Contributor** on the storage account, the upload would still fail. Those are **control-plane** roles: they allow managing the storage account resource (its settings, firewall, and tags), but they do **not** include permission to read or write the data inside it. Blob data access needs a **data-plane** role such as **Storage Blob Data Reader** or **Storage Blob Data Contributor**.
    ...
    ![](https://docs-api.cloudlabs.ai/repos/raw.githubusercontent.com/CloudLabs-Samples/EduLabs/refs/heads/main/Demo/Azure-VM-Troubleshooting-Lab/LabGuidePackage/Image/m02-portal-identity-no-roles.png)
...
1. Run the following command to run the report job, retrying every 30 seconds until the role assignment has propagated. It normally succeeds within two minutes.
    ...
    **Expected Output:**
    ...
    ![](https://docs-api.cloudlabs.ai/repos/raw.githubusercontent.com/CloudLabs-Samples/EduLabs/refs/heads/main/Demo/Azure-VM-Troubleshooting-Lab/LabGuidePackage/Image/m02-portal-container-iam.png)
