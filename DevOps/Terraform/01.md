...
In this exercise, you will learn about basics of Terraform and install Terrafrom on the virtual machine provided to you.
...
1. Run the below command to initialize your `learn-terraform-azure` directory in your terminal. 
     ...
     ```
      ...
      > **Info**: The above command will prepare a directory and pull down the resources that you have defined in your file.
...
1. Now, you need to import the created Resource group by running the below command in **Windows PowerShell (Admin)**.
     ...
     > **Info:** When you apply your configuration, Terraform writes data into a file called **terraform.tfstate**. This file contains the IDs and properties of the resources Terraform created so that it can manage or destroy those resources going forward. 
