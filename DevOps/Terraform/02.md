...
In this task, you will create a Virtual Network within the resource group which you have created in the previous exercise using Terraform .
...
Along with the creation of new resoureces, terraform also supports the modification of existing resources. In this task, you will be adding the tags to the existing resource group.
