...
Along with the creation of new resources, terraform also supports the modification of existing resources. In this task, you will be adding the tags to the existing resource group.
