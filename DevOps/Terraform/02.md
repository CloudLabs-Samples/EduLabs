...
In this task, you will create a Virtual Network using Terraform within the resource group which you have imported into theTerraform state in the previous exercise.
