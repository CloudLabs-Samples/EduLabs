...
In this task, you will create a subnet within the VNet which you have created in the previous tasks using Terraform.
...
In this task, you will create a new Public IP Address using Terraform. This will be used while deploying the Virtual Machine where you are going to create it in the next tasks.
