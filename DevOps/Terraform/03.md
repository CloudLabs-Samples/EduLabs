...
In this exercise, you will create resources Subnet and Public IP address using Terraform those will be used while creating the Virtual Machine in the upcoming exercises.
