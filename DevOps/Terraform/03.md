...
In this exercise, you will create a Subnet and Public IP address using Terraform. These resources will be used while creating the Virtual Machine in the upcoming exercises.
...
In this task, you will create a new Public IP Address using Terraform. This will be used while deploying the Virtual Machine where you are going to create it in the next exercise.
