...
3. In Visual studio code click on **File** and select **New Text File**.

   ![](./images/docke41.png "SSMS Toolbar")
...
11. Now login to the Docker Hub using the below command. When prompted, enter your docker username and password. If you don't register Docker Hub before, please follow step 12.
...
12. In edge browser, go to docker hub **https://hub.docker.com/**, navigate to the **Register** section, and Register with your email account.

 
    ![](./images/register.png)

    
13. In edge browser, login to docker hub **https://hub.docker.com/**, navigate to **Repositories** section and create a repository with the name **`mydemo-images`**.
