...
6. Start your container by running the below command:
    ...
    ```
    -  syntax: **docker container start your_container_name**
...
10. Now run the below command to get the process details of the container.
    ...
    docker top prod
    ```
    - syntax: **docker top your_container_name**
...
14. Now copy the  temp file which you create inside the container to  the host machine by running the below command
    ...
    ```
    - **Syntax**: `docker cp your_container_name:Source_path Dest_path`
...
2. On your LabVM desktop right click on **docker instance(2)** and select **Switch to Windows containers(3)**. By default docker desktop platform is set to linux containers , to pull an windows image the docker platform needs to be set to Windows container.

   ![](./images/dock18.png "SSMS Toolbar")

   
2. Once the docker is restarted navigate back to terminal and  pull an image from the docker hub by running the below command:
...
4. In the terminal navigate to **c:\files** and build the container image using the docker build command.
   ...
   ![](./images/dock20.png "SSMS Toolbar")
...
6. Now that you have an image ready, create and run a container from the image using the below command. 
   ...
   ![](./images/dock21.png "SSMS Toolbar")
...
7. Run the below command to get the IP address of the container.
   ...
   ```
   ![](./images/dock26.png "SSMS Toolbar")
...
9. Verify that you are able to see the IIS web page.
   ...
   ![](./images/dock22.png "SSMS Toolbar")
...
12. In edge browser login to docker hub and create an repository with the name `getting-started`.

13. Use the docker tag command to give your image a new name. Be sure to replace YOUR-USER-NAME with your Docker ID.

    ```
    docker tag  iis-site YOUR-USER-NAME/Repository-Name:V1
    ```
    
    ![](./images/dock24.png "SSMS Toolbar")
...
14.  Push your image to the repository you created
     ...
     ```
     ![](./images/dock25.png "SSMS Toolbar")
...
6. List the containers and verify you are able to see the Ngnix and Redis containers
   ...
   docker ps -a
   ```
   ![](./images/dock29.png "SSMS Toolbar")
...
8.  Now stop the application by running the below command. 
    ...
    docker-compose down
    ```
    ![](./images/dock32.png "SSMS Toolbar")
