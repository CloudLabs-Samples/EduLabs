...
In this exercise, you will learn how to work with Docker compose and how to specify the services in a YAML file and then spin everything up or down with a single command.
