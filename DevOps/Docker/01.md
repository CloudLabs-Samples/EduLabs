...
In this exercise you will how to create and inspect network in docker, add containers in the network using docker commands.

#### Task 1: Create a container on the default network

In this task you will create a docker container and inspect in which network the conatier is created
...
In this task you will create a network and create containers in it
