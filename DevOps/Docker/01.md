...
In this lab you have learnet how to work with Docker, how to create Docker container and container perform operations. You also created docker images, learnt how to pull and push images to Docker hub. 
   
In this lab you have learnt the following:
   
- Run basic Docker commands

- Created Docker Container and performed Container operations
   
- Created Docker Images from docker file and created a container from the image with the Nginx website hosted on it. You also learnt how to pull and push images to the Docker Hub.
