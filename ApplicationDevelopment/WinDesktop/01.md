...
1. Wait until the VSIX installer is initialized, once it is done click on **Install** to accept the license terms and installation of pre-requisites.

   ![](./media/extensions1.png)

1. Once the extension is installed, click on **Close**the VSIX installer blade to close it.

   ![](./media/extensions2.png)
